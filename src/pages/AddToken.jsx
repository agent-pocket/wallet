        ...
        <div className="page">
            <div className="row gap-10">
                ...
                <div className="col">
                    ...
                    <p className="subtitle">Import ERC-20 token on {network.toUpperCase()}.</p>
                </div>
            </div>
            ...
            <Card className="col gap-12" style={{ flex: 1 }}>
                ...
                <Card variant="inset" style={{ padding: 12 }}>
                    <p className="subtitle">Paste the token contract address and verify token legitimacy before importing.</p>
                </Card>
